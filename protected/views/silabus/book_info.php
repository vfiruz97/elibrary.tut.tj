    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading" align = 'right'>
                <a href="/book" class='btn btn-success'><i class="fa fa-arrow-left" aria-hidden="true"></i> <?= Yii::t('app','Назад') ?></a>
                <a href="read?id=<?= $book->id ?>" target='new_blank' class='read-book btn btn-success'><i class="fa fa-book"></i> <?= Yii::t('app','Читать') ?></a>
                <a href="../<?= $book->path ?>" download target="_blank" class="download btn btn-success"><i class="fa fa-file-pdf-o"></i> <?= Yii::t('app','Скачать') ?></a>   
            </div>
                    ...
                    <div class="row">                    
                        ...
                        <div class="col-md-9" style="">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <?= Yii::t('app', 'Категория').": <h4 class='info_book'>$book->category_ru</h4>" ?> 
                                </div> 
                                <div class="col-md-12">
                                    <?= Yii::t('app', 'Подкатегория').": <h4 class='info_book'>$book->subcategory_ru</h4>" ?>
                                </div> 
                                <div class="col-md-12">
