...
<?php if (isset($report) && $report->processed): ?>
    ...
    <?php else: ?>
        <p >
            <button type="button" class="btn btn-sm btn-success download-report-export-to-excel" data-target="<?= Url::toRoute('/report/export-to-excel?command=download') ?>"><i class="fa fa-fw fa-lg fa-file-excel-o"></i> <?= Yii::t('app', 'Выгрузить в Excel') ?></button>
        </p>

        <table id="download-report-table" class="table table-bordered  report-table">
            <colgroup>
                <col width="50"/>
                <col width="200">
                <col width="200"/>
